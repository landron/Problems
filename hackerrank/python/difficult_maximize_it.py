...
def debug_validations():
    '''unit testing'''
    assert maxim_powers([{16, 25, 4}, {64, 9, 49, 81}, {64, 25, 49, 81, 100}], 1000) == 206
    assert maxim_powers([{16, 25}, {64, 49, 81}, {64, 25, 49, 81, 100}], 1000) == 206
    assert maxim_powers([{100, 287}, {685, 654}, {105}, {560, 64, 536, 295}, {417, 295},\
     {225, 66, 712, 121, 94}], 767) == 763
